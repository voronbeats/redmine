...
<div class="task-view container">
    ...
    <p>
        ...
        <?= Html::a('Обновить', ['update', 'id' => $model->id], ['class' => 'btn btn-primary redactor']) ?>
        <?= Html::a('Удалить', ['delete', 'id' => $model->id], [
            'class' => 'btn btn-danger redactor',
            'data' => [ 
                'confirm' => 'Are you sure you want to delete this item?',
                'method' => 'post',
            ],
        ]) ?>
        <?= Html::a('Трудозатраты', ['labor-costs/create', 'id' => $model->id], ['class' => 'btn btn-success redactor']) ?>
        <? } ?>
    </p>
