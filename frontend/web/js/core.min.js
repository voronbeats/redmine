...
var bootstrap = function(t, e, n) {
  ...
  var s = function() {
      ...
      u = function() {
          if ("undefined" == typeof n) throw new Error("Bootstrap dropdown11 require Popper.js (https://popper.js.org)");
          var t = "dropdown11",
              i = "bs.dropdown11",
              o = "." + i,
              a = e.fn[t],
              ...
              h = {
                  ...
                  SHOWN: "shown" + o,
                  CLICK: "click" + o,
                  CLICK_DATA_API: "click.bs.dropdown11.data-api",
                  KEYDOWN_DATA_API: "keydown.bs.dropdown11.data-api",
                  KEYUP_DATA_API: "keyup.bs.dropdown11.data-api"
              },
              c = {
                  DISABLED: "disabled",
                  SHOW: "show",
                  DROPUP: "dropup",
                  MENURIGHT: "dropdown11-menu-right",
                  MENULEFT: "dropdown11-menu-left"
              },
              u = {
                  DATA_TOGGLE: '[data-toggle="dropdown11"]',
                  FORM_CHILD: ".dropdown11 form",
                  MENU: ".dropdown11-menu",
                  NAVBAR_NAV: ".navbar-nav",
                  VISIBLE_ITEMS: ".dropdown11-menu .dropdown11-item:not(.disabled)"
              },
              d = {
                  TOP: "top-start",
                  TOPEND: "top-end",
      ...
      g = function() {
          var t = "scrollspy",
              ...
              l = {
                  dropdown11_ITEM: "dropdown11-item",
                  dropdown11_MENU: "dropdown11-menu",
                  ACTIVE: "active"
              },
              h = {
                  ...
                  dropdown11_ITEMS: ".dropdown11-item",
                  dropdown11_TOGGLE: ".dropdown11-toggle"
              },
              c = {
                  OFFSET: "offset",
                  POSITION: "position"
              ...
              u = function() {
                  function n(t, n) {
                      var i = this;
                      this._element = t, this._scrollElement = "BODY" === t.tagName ? window : t, this._config = this._getConfig(n), this._selector = this._config.target + " " + h.NAV_LINKS + "," + this._config.target + " " + h.LIST_ITEMS + "," + this._config.target + " " + h.dropdown11_ITEMS, this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, e(this._scrollElement).on(a.SCROLL, function(t) {
                          return i._process(t)
                  ...
                  return u.refresh = function() {
                      ...
                      var i = e(n.join(","));
                      i.hasClass(l.dropdown11_ITEM) ? (i.closest(h.dropdown11).find(h.dropdown11_TOGGLE).addClass(l.ACTIVE), i.addClass(l.ACTIVE)) : (i.addClass(l.ACTIVE), i.parents(h.NAV_LIST_GROUP).prev(h.NAV_LINKS + ", " + h.LIST_ITEMS).addClass(l.ACTIVE), i.parents(h.NAV_LIST_GROUP).prev(h.NAV_ITEMS).children(h.NAV_LINKS).addClass(l.ACTIVE)), e(this._scrollElement).trigger(a.ACTIVATE, {
                          relatedTarget: t
                      })
                  }, u._clear = function() {
      ...
      m = function() {
          var t = e.fn.tab,
              ...
              o = {
                  ...
                  dropdown11_TOGGLE: ".dropdown11-toggle",
                  dropdown11_ACTIVE_CHILD: "> .dropdown11-menu .active"
              },
              a = function() {
                  function t(t) {
                      this._element = t
                  ...
                  return a.show = function() {
                      ...
                      if (n) {
                          ...
                          var l = e(n.parentNode).find(o.dropdown11_ACTIVE_CHILD)[0];
                          l && e(l).removeClass(i.ACTIVE), "tab" === n.getAttribute("role") && n.setAttribute("aria-selected", !1)
                      }
                      if (e(t).addClass(i.ACTIVE), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0), r ? (s.reflow(t), e(t).addClass(i.SHOW)) : e(t).removeClass(i.FADE), t.parentNode && e(t.parentNode).hasClass(i.dropdown11_MENU)) {
                          var h = e(t).closest(o.dropdown11)[0];
                          h && e(h).find(o.dropdown11_TOGGLE).addClass(i.ACTIVE), t.setAttribute("aria-expanded", !0)
                      }
                      a && a()
                  }, t._jQueryInterface = function(n) {
                      return this.each(function() {
  ...
  }(), t.Util = s, t.Alert = a, t.Button = l, t.Carousel = h, t.Collapse = c, t.dropdown11 = u, t.Modal = d, t.Popover = _, t.Scrollspy = g, t.Tab = m, t.Tooltip = f, t
}({}, $, Popper);
/**
* @module       Regula
...
function(e, t) {
  ...
  var a = {
      ...
      Integer: {
          ...
          compound: !1,
          params: [],
          defaultMessage: "{label} должен быть числовым."
      },
      Real: {
          async: !1,
          html5: !1,
      ...
      function(n, o, e) {
          ...
          a = function() {
              ...
              return a.prototype.Defaults = {
                  ...
                  return t.$element.find(".rd-navbar-dropdown11, .rd-navbar-megamenu").each(function() {
                      var t;
                      return t = n(this), this.getBoundingClientRect(), t.hasClass("rd-navbar-megamenu") ? t.parent().addClass("rd-navbar--has-megamenu") : t.parent().addClass("rd-navbar--has-dropdown11")
              ...
              }, a.prototype.dropdown11Over = function(t, o) {
                  var e;
                  if (t.focusOnHover) {
                      if (e = n(this), clearTimeout(o), t.options.callbacks.ondropdown11Over && !t.options.callbacks.ondropdown11Over.call(this, t)) return this;
                      e.addClass("focus").siblings().removeClass("opened").each(t.dropdown11Unfocus)
                  }
                  return this
              }, a.prototype.dropdown11Touch = function(t, o) {
                  var e, a;
                  if (e = n(this), clearTimeout(o), t.focusOnHover) {
                      if (a = !1, e.hasClass("focus") && (a = !0), !a) return e.addClass("focus").siblings().removeClass("opened").each(t.dropdown11Unfocus), !1;
                      t.options.callbacks.ondropdown11Over && t.options.callbacks.ondropdown11Over.call(this, t)
                  }
                  return this
              }, a.prototype.dropdown11Out = function(t, o) {
                  return t.focusOnHover && (n(this).one("mouseenter.navbar", function() {
                      return clearTimeout(o)
                  }), t.options.callbacks.ondropdown11Out && t.options.callbacks.ondropdown11Out.call(this, t), clearTimeout(o), o = setTimeout(n.proxy(t.dropdown11Unfocus, this, t), t.options.focusOnHoverTimeout)), this
              }, a.prototype.dropdown11Unfocus = function(t) {
                  return n(this).find("li.focus").add(this).removeClass("focus"), this
              }, a.prototype.dropdown11Close = function(t, o) {
                  return o.target === this || n(o.target).parents(".rd-navbar-submenu").length || (n(this).find("li.focus").add(this).removeClass("focus").removeClass("opened"), t.options.callbacks.ondropdown11Close && t.options.callbacks.ondropdown11Close.call(this, t)), this
              }, a.prototype.dropdown11Toggle = function(t) {
                  return n(this).toggleClass("opened").siblings().removeClass("opened"), t.options.callbacks.ondropdown11Toggle && t.options.callbacks.ondropdown11Toggle.call(this, t), this
                  ...
                  return null != t.options.responsive && t.$win.on("resize.navbar", n.proxy(t.resize, t.$win[0], t)).on("resize.navbar", n.proxy(t.resizeWrap, t)).on("resize.navbar", n.proxy(t.stickUp, null != t.$clone ? t.$clone : t.$element, t)).on("orientationchange.navbar", n.proxy(t.resize, t.$win[0], t)).trigger("resize.navbar"), t.$doc.on("scroll.navbar", n.proxy(t.stickUp, null != t.$clone ? t.$clone : t.$element, t)).on("scroll.navbar", n.proxy(t.activateAnchor, t)), t.$element.add(t.$clone).find("[data-rd-navbar-toggle]").each(function() {
                      ...
                      var o, e;
                      return o = n(this), e = o.parents(".rd-navbar--is-clone").length ? t.cloneTimer : t.focusTimer, o.on("mouseleave.navbar", n.proxy(t.dropdown11Out, this, t, e)), o.find("> a").on("mouseenter.navbar", n.proxy(t.dropdown11Over, this, t, e)), o.find("> a").on("touchstart.navbar", n.proxy(t.dropdown11Touch, this, t, e)), o.find("> .rd-navbar-submenu-toggle").on("click", n.proxy(t.dropdown11Toggle, this, t)), o.parents("body").on("click", n.proxy(t.dropdown11Close, this, t))
                  }), t.$element.add(t.$clone).find('.rd-navbar-nav a[href^="#"]').each(function() {
                      return n(this).on("click", n.proxy(t.goToAnchor, this, t))
                  }), t.$element.find(".rd-navbar-dropdown11, .rd-navbar-megamenu").each(function() {
                      var t, o;
...
function(a, b) {
  ...
  ! function() {
      ...
      var b = {
              share: !0,
              facebook: !0,
              facebookdropdown11Text: "Facebook",
              twitter: !0,
              twitterdropdown11Text: "Twitter",
              googlePlus: !0,
              googlePlusdropdown11Text: "GooglePlus",
              pinterest: !0,
              pinterestdropdown11Text: "Pinterest"
          },
          c = function(c) {
      ...
      c.prototype.init = function() {
          var b = this,
              c = '<span id="lg-share" class="lg-icon"><ul class="lg-dropdown11" style="position: absolute;">';
          c += b.core.s.facebook ? '<li><a id="lg-share-facebook" target="_blank"><span class="lg-icon"></span><span class="lg-dropdown11-text">' + this.core.s.facebookdropdown11Text + "</span></a></li>" : "", c += b.core.s.twitter ? '<li><a id="lg-share-twitter" target="_blank"><span class="lg-icon"></span><span class="lg-dropdown11-text">' + this.core.s.twitterdropdown11Text + "</span></a></li>" : "", c += b.core.s.googlePlus ? '<li><a id="lg-share-googleplus" target="_blank"><span class="lg-icon"></span><span class="lg-dropdown11-text">' + this.core.s.googlePlusdropdown11Text + "</span></a></li>" : "", c += b.core.s.pinterest ? '<li><a id="lg-share-pinterest" target="_blank"><span class="lg-icon"></span><span class="lg-dropdown11-text">' + this.core.s.pinterestdropdown11Text + "</span></a></li>" : "", c += "</ul></span>", this.core.$outer.find(".lg-toolbar").append(c), this.core.$outer.find(".lg").append('<div id="lg-dropdown11-overlay"></div>'), a("#lg-share").on("click.lg", function() {
              b.core.$outer.toggleClass("lg-dropdown11-active")
          }), a("#lg-dropdown11-overlay").on("click.lg", function() {
              b.core.$outer.removeClass("lg-dropdown11-active")
